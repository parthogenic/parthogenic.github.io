...
//        console.info(this.config);
        ...
        this.mouseOverListCbx.setValue(this.config.mouseoverlist || false);
      ...
      getConfig: function() {
        ...
        generalOps.mouseoverlist = this.mouseOverListCbx.getValue();
